...
// 		var tmplName = name.replace(/\.[^\.]*$/, "") + ".html";
...
util.com.getHtmlConf = function(entry, outFile, tmplName) {
	tmplName = tmplName || outFile;
	return new HtmlWebpackPlugin({
		filename: path.resolve(__dirname, conf.com.outPath + "/" + outFile),
		template: tmplName,
		inject: true,
		chunks: ['manifest', 'polyfill', 'vendors', entry]
	});
};

util.com.getDevHtmlConf = function(entry, outFile, tmplName) {
	tmplName = tmplName || outFile;
	return new HtmlWebpackPlugin({
		filename: path.resolve(__dirname, conf.com.outPath + "/" + outFile),
		template: tmplName,
